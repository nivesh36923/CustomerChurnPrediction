...
Account_length = st.number_input("**Account length:**", value=1000,step=1)
Area_code = st.number_input("**Area code**", value=1000,step=1)
Total_day_minutes = st.number_input("**Total day minutes:**", value=3.452)
Total_day_calls = st.number_input("**Total day calls:**",value=1000,step=1)
...
Total_eve_calls = st.number_input("**Total eve calls:**", value=1000,step=1)
...
Total_night_calls = st.number_input("**Total night calls:**",value=1000,step=1)
Total_night_charge = st.number_input("**Total night charge:**", value=3.452)
Customer_service_calls = st.number_input("**Customer service calls:**",value=1000,step=1)
